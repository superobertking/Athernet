...
# @Last Modified time: 2018-11-18 21:41:35
...
if __name__ == '__main__':
	...
	with MAC(addr=0xee, rx_device=args.recv_device, tx_device=args.send_device, ack_timeout=0.5, max_retries=20, mtu=512) as mac:
